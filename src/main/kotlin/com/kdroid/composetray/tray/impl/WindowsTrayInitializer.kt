...
object WindowsTrayInitializer {
    fun initialize(iconPath: String, tooltip: String, onLeftClick: (() -> Unit)? = null,  menuContent: TrayMenuBuilder.() -> Unit) {
        ...
        val trayMenuImpl = WindowsTrayMenuBuilderImpl(iconPath, tooltip, onLeftClick).apply(menuContent)
